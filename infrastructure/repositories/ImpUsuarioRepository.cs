...
namespace campuslove.infrastructure.repositories
{
    public class ImpUsuarioRepository : IGenericRepository<Usuario>, IUsuarioRepository
    {
        ...
        public void Actualizar(Usuario entity)
        {
            ...
            string query = "UPDATE usuario SET nombre=@nombre, apellido=@apellido, genero=@genero, id_carrera = @id_carrera WHERE cedula_ciudadania=@cedula_ciudadania";
        ...
        {
            var connection = _conexion.ObtenerConexion();
            string query = "INSERT INTO usuario(cedula_ciudadania, nombre, apellido, genero, id_carrera) VALUES(@cedula_ciudadania, @nombre, @apellido, @genero, @id_carrera)";
             using var cmd = new NpgsqlCommand(query, connection);
             cmd.Parameters.AddWithValue("@cedula_ciudadania", entity.cedula_ciudadania);
             cmd.Parameters.AddWithValue("@nombre", entity.nombre);
             cmd.Parameters.AddWithValue("@apellido", entity.apellido);
        ...
        public List<Usuario> ObtenerTodos()
        {
            ...
            string query = "SELECT cedula_ciudadania, nombre, apellido, genero, id_carrera FROM usuario";
            using var cmd = new NpgsqlCommand(query, connection);
